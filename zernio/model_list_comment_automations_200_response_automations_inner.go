...
func (o *ListCommentAutomations200ResponseAutomationsInner) GetExcludeKeywords() []string {
...
// and a boolean to check if the value has been set.
func (o *ListCommentAutomations200ResponseAutomationsInner) GetExcludeKeywordsOk() ([]string, bool) {
	if o == nil || IsNil(o.ExcludeKeywords) {
		return nil, false
	}
...
func (o *ListCommentAutomations200ResponseAutomationsInner) HasExcludeKeywords() bool {
	if o != nil && !IsNil(o.ExcludeKeywords) {
		return true
	}
...
func (o *ListCommentAutomations200ResponseAutomationsInner) SetExcludeKeywords(v []string) {
	o.ExcludeKeywords = v
}

// GetTypoTolerance returns the TypoTolerance field value if set, zero value otherwise.
func (o *ListCommentAutomations200ResponseAutomationsInner) GetTypoTolerance() bool {
...
// and a boolean to check if the value has been set.
func (o *ListCommentAutomations200ResponseAutomationsInner) GetTypoToleranceOk() (*bool, bool) {
	if o == nil || IsNil(o.TypoTolerance) {
		return nil, false
	}
...
func (o *ListCommentAutomations200ResponseAutomationsInner) HasTypoTolerance() bool {
	if o != nil && !IsNil(o.TypoTolerance) {
		return true
	}
...
func (o *ListCommentAutomations200ResponseAutomationsInner) SetTypoTolerance(v bool) {
	o.TypoTolerance = &v
}
